...
function badd(xkid, xnojo, xkdone, xkpro, xknpro, xknlok, xklok, btn, zparam, xjabatan, xskill, ketcan, tyjo, cuk, ntype, upd, alev, lev_sap, persa_sap, skill_sap, area_sap, jab_sap, skema_sap, abkrs_sap, jpro_sap, kontrakh, dekomp, jnew, new_trep, pernernorek, nreason, sestype, username, cpilpks, cdokpks, cdivisiid){
	// alert(username);
						...
						<table id="listorder" class="table table-bordered table-hover">
							<thead style="background-color: #dd4b39; color:white;">
								...
								<tr>
									...
									<th><select name="cardone" id="cardone" class="form-control select2 pull-right" style="width:80px"><option value=""></option><option value="1">DONE</option><option value="2">OnProgress</option></select></th>
									<?php } ?>
								</tr>
