			...
			$.ajax({
				...
				success: function(data) {
					...
					if (type_jo == 2) {
						...
						var type = "POST";
						var mimeType = "multipart/form-data";
						arrjoborder = [tanggal, lama, '', '', komponen4, komponen5, komponen6, type_jo, jenisproject, xtype_jo, typere, xnobak, lperner, jeniscapt, tperal, ncust_id, ncust_name, lpernergan, pks];
						$.post(url, {
						...
						var mimeType = "multipart/form-data";
						var sapi = vkumdocx;
						arrjoborder = [tanggal, project, syarat, deskripsi, lama, '', '', komponen4, komponen5, komponen6, type_jo, jenisproject, lrincian, xtype_jo, typere, respa, tnew, lkomponenx, xnobak, lproczx, vkumdocx, tglgaji, tpeng, ncust_id, ncust_name, jeniscapt, tperal, sproject, eproject, nilpro, pks];
						$.post(url, {
							joborder: arrjoborder,
							sapi: sapi
						}, function(resp) {
...
-->
						...
						-->
								...
								<div class="form-group">
									<label class="col-sm-3 control-label">PKS</label>
									<div class="col-sm-9">
