		...
		$('body').on('click', '#btn_simpan', function(e){
				...
				*/
				...
				$('#listrincian tbody tr').each(function(){
					...
					lrincian += [ljabatan, lgender, lpendidikan, llokasi, lwaktu, latasan, lkontrak, ljumlah, lskema, lskema_text, lskillx, lskillx_text, n_ljabatan, n_llokasi, kump, tot, kidx, lktrain];
				...
				$.ajax({
					...
					success: function (data) {   
							...
							if(type_jo==2){
								...
								var	type 		= "POST";
								var mimeType    = "multipart/form-data";
								arrjoborder = [tanggal, lama, latihan, bekerja, komponen4, komponen5, komponen6, type_jo, jenisproject, xtype_jo, typere, xnobak, lperner, jeniscapt, tperal, ncust_id, ncust_name];
								$.post(url, {joborder:arrjoborder}, function(resp){
									$('#overlay').hide();
									alert('Data Tersimpan');
									location.reload();
								...
								var mimeType    = "multipart/form-data";
								var sapi = vkumdocx; 
								arrjoborder = [tanggal, project, syarat, deskripsi, lama, latihan, bekerja, komponen4, komponen5, komponen6, type_jo, jenisproject, lrincian, xtype_jo, typere, respa, tnew, lkomponenx, xnobak, lproczx, vkumdocx, tglgaji, tpeng, ncust_id, ncust_name, jeniscapt, tperal];
...
-->  
						<div class="form-group" id="divtper" >
							...
							<div class="col-sm-9">
								<div class="col-sm-3">
								<input type="radio" id="tperal" name="tperal" value="ISH" checked=checked> ISH 
								</div>
								<div class="col-sm-6">
								<input type="radio" id="tperal" name="tperal" value="INF"> INF (PERALIHAN)	
								</div>
							</div>
						</div>
