	...
	//$(document).ready(function(){
		...
		*/
		...
		$("#rbtn_simpan").click(function(){
			...
			arrappjo = [vnojo, nid, rket, tjok, namaz, ruspm];
...
function badd(xkid, xnojo, xkdone, xkpro, xknpro, xknlok, xklok, btn, zparam, xjabatan, xskill, ketcan, tyjo, cuk, ntype, upd, alev, lev_sap, persa_sap, skill_sap, area_sap, jab_sap, skema_sap, abkrs_sap, jpro_sap, kontrakh, dekomp, jnew){
	// alert(btn);
	//console.log(anj);
	$('#overlayx').show();     
	$('#xoverlay').show();
	...
	else 
	{
		...
		$("#btnsimpan2").click(function(){
			...
			*/
			...
			arrappjo = [vnojo, vid, jenisarea, det_area, jenispersa, det_persa, jenisskill, n_jenisskill, jenisjabatan, jenislevel, n_jenislevel, jenisproject, n_jenisproject, zskema, scancel, jenispay, n_jenisjabatan, uspm];	
			$.post(url, {data : arrappjo}, function(res){
				alert('Sukses');
				location.reload();
			})
		...
		$("#btnsimpan1").click(function(){
			...
			arrappjo = [vnojo, vid, jenisarea, det_area, jenispersa, det_persa, jenisskill, n_jenisskill, jenisjabatan, jenislevel, n_jenislevel, jenisproject, n_jenisproject, zskema, lkomponenx, scancel, jenispay, n_jenisjabatan, xnojo, xklok, xjabatan, alev, zkontrakh, xskill, uspm];
...
$(function(){
	...
	$("#listorder").DataTable({
		...
		{ 
            "targets": [ 0, 2, 4, 7, 9, 12, 13, 14, 23, 25, 26 ], //first column / numbering column
            "orderable": false,
        },
        ],
	});
