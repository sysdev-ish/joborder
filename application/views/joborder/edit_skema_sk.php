	...
	$(document).ready(function(){
		...
		*/
		...
		$('body').on('click', '#btn_submit1', function(e){
				...
				$.ajax({
					url: '<?php echo base_url("index.php/home/s_edit_skema_sk") ?>',
					type: 'POST',
					//dataType   : 'json',
					xhr: function() {
			...
			<!-- form start -->
					<div class="box-body">
						...
						<div class="form-group" id="divnojo">
							...
							<div class="col-sm-9">
								<input type="hidden" class="form-control pull-right" id="nid" name="nid" value="<?php echo $id ?>" readonly />
								<input type="hidden" class="form-control pull-right" id="area" name="area" value="<?php echo $area ?>" readonly />
								<input type="hidden" class="form-control pull-right" id="perar" name="perar" value="<?php echo $perar ?>" readonly />
								<input type="text" class="form-control pull-right" id="n_area" name="n_area" value="<?php echo $n_area ?>" readonly />
							</div><!-- /.input group -->
						</div><!-- /.form group -->
						...
						<div class="form-group" id="divnojo">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control pull-right" id="n_perar" name="n_perar" value="<?php echo $n_perar ?>" readonly />
							</div><!-- /.input group -->
						</div><!-- /.form group -->
						...
						<div class="form-group" id="group_att">
							...
							<?php } else {
								$abc = 'skema'; ?>
								<label class='control-label' style='color:grey' value='<?php echo $dokumen_skema ?>' name='kompak[]' id='kompak_skema'><?php echo $dokumen_skema ?><button title='Delete Skema File' type='button' class='btn btn-box-tool' onclick='delfile("<?php echo $nojo ?>","<?php echo $dokumen_skema ?>", "<?php echo $abc ?>");this.parentNode.parentNode.removeChild(this.parentNode);'><i class='fa fa-times' ></i></button></label><br> 
							<?php }
							?>
							</div><!-- /.input group -->
						</div><!-- /.form group -->
						...
						<div class="form-group" id="group_att1">
							...
							<?php } else { 
								$cde = 'bak'; ?>
								<label class='control-label' style='color:grey' value='<?php echo $dokumen_bak ?>' name='kompak[]' id='kompak_bak'><?php echo $dokumen_bak ?><button title='Delete BAK File' type='button' class='btn btn-box-tool' onclick='delfile("<?php echo $nojo ?>","<?php echo $dokumen_bak ?>", "<?php echo $cde ?>");this.parentNode.parentNode.removeChild(this.parentNode);'><i class='fa fa-times' ></i></button></label><br>
							<?php }
							?>
						...
						<div class="form-group" id="group_att2">
							...
							<?php } else {
								$fgh = 'other'; ?>
								<label class='control-label' style='color:grey' value='<?php echo $dokumen_other ?>' name='kompak[]' id='kompak_other'><?php echo $dokumen_other ?><button title='Delete Other File' type='button' class='btn btn-box-tool' onclick='delfile("<?php echo $nojo ?>","<?php echo $dokumen_other ?>", "<?php echo $fgh ?>");this.parentNode.parentNode.removeChild(this.parentNode);'><i class='fa fa-times' ></i></button></label><br>
							<?php }
							?>
							</div><!-- /.input group -->
						</div><!-- /.form group -->
