									...
									foreach($transjo as $key => $list){
										...
										if ($level == '3'){
											...
											else
											{
												...
												/*
												echo "
												<button type='submit' class='btn btn-success btn-block btn-xs btnhold' id='btnhold' data-toggle='modal' data-target='#EZModal'>Cancel</button>
												";
												*/
											}
										} /*else if ($level == '5'){?>
