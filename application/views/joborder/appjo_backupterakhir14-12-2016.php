	...
	$(function () {
		...
		$(".btnadd").click(function(){
			...
			$("#labeljon").html('<label class="control-label"> Anda akan menyetujui Job order No '+ vnojo +'</label>');
				...
				var appbtn2 = '<button type="button" class="btn btn-outline" data-dismiss="modal" id="btnsimpan1">Approve Admin</button>'
						...
						<div class="modal-body">
							...
							<div id="testing">	
									...
									<ul class="nav nav-tabs">
									  <li role="presentation" class="active"><a href="#tab1" data-toggle="tab">Gambar Diri 1-6</a></li>
									  <li role="presentation"><a href="#tab2" data-toggle="tab">Gambar Diri 7-12</a></li>
									  <li role="presentation"><a href="#tab3" data-toggle="tab">Gambar Diri 13-18</a></li>
									  <li role="presentation"><a href="#tab4" data-toggle="tab">Gambar Diri 19-24</a></li>
									</ul>
