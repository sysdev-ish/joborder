...
<div class="col-md-5 form-group" id="divdes1">
		...
		<?php echo "<textarea class='form-control' rows='3' name='zdes' id='zdes' placeholder='Description'>". $urut_desk[$i] ."</textarea>" ?>	
</div><!-- /.form group -->

<div class="form-group col-md-2" id="divhdes1">
	<label class=" control-label">Hasil 1</label>
		<select class="form-control pull-right" id="zh_des" name="zh_des" style="width:100%; margin-bottom:70px;">
...
<div class="form-group col-md-12" id="divkesimpulan">
	...
	<div class="">
		<textarea id="zkesimpulan" rows="5" name="zkesimpulan" class="form-control" placeholder="Kesimpulan Pewawancara"><?php echo $ghj; ?></textarea>
	</div><!-- /.input group -->
</div><!-- /.form group -->
...
<div class="form-group col-md-12" id="divstatus">
	...
	<div class="">
		<select class="form-control pull-right" id="zstatus" name="zstatus" style="width:100%;">
...
<div class="col-md-5 form-group" id="divdes1">
		<label class=" control-label">Deskripsi</label> 
		<textarea class='form-control' rows='3' name='zdes' id='zdes' placeholder='Description'></textarea>
</div><!-- /.form group -->
...
<div class="form-group col-md-12" id="divkesimpulan">
	<label class=" control-label">Kesimpulan Pewawancara</label>
	<div class="">
		<textarea id="zkesimpulan" rows="5" name="zkesimpulan" class="form-control" placeholder="Kesimpulan Pewawancara"></textarea>
	</div><!-- /.input group -->
</div><!-- /.form group -->
