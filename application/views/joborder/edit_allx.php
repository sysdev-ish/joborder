...
<style>
 ...
 .divpernerexist{ overflow-x: scroll; }
 .listpernerx{margin:40px auto 0px auto; }
</style>
	...
	$(document).ready(function(){
		...
		*/
		...
		$("#ypernery").change(function(){
			...
			$.post(url, {data:pganti}, function(response){
				...
				*/
				...
				else
				{
					...
					$('#listrincian tbody tr').each(function(){
						...
						lrincianx += [ljabatan, lgender, lpendidikan, llokasi, lwaktu, latasan, lkontrak, ljumlah, lskema, lskema_text, lskillx, lskillx_text, n_ljabatan, n_llokasi, kump, tot, kidx, lktrain, nlatihan, nbekerja, typeng, lpnorek, ljskema, lreasonrot, ldetkompo];
						//lrincian += [ljabatan, lgender, lpendidikan, llokasi, lwaktu, latasan, lkontrak, ljumlah, lskema, lskillx];
						lrincianx += ',';
					})
				}
				...
				$.ajax({
					...
					success: function (data) { 
							...
							if(tjo==2){
								...
								arrjoborder = [tanggal, lama, '', '', tjo, typere, xnobak, approv, nojok, lperner, tperal, jeniscapt, ncust_id, ncust_name, lpernergan];
								...
								var mimeType    = "multipart/form-data";
								var sapi = vkumdocx; 
								arrjoborder = [tanggal, project, syarat, deskripsi, lama, '', '', tjo, lrincianx, typere, nojok, approv, krespa, respa, tnew, xnobak, lkomponenx, lproc, vkumdocx, ncust_id, ncust_name, tpeng, tperal, jeniscapt, sproject, eproject, nilpro];
					...
					<?php } ?>
						...
						<div id="btsrep" class="col-xs-12" style="width:100%;height:100%;border:1px solid #000; margin-bottom:10px;">
							...
							<div class="form-group" id="divnperganti">
								...
								<div class="col-sm-9">
									<select class="form-control pull-right" id="ypernery" name="ypernery" style="width:100%;" <?php if($tjo==2){echo "disabled=disabled";}?>/>
							...
							<div class="form-group" id="divresign">
								...
								<div class="col-sm-9">
									<select class="form-control pull-right" id="alasan_ganti" name="alasan_ganti" style="width:100%;" <?php if($tjo==2){echo "disabled=disabled";}?>/>
										<option value="">Pilih</option>
