	...
	if (count($rincian)){
		foreach($rincian as $key => $list){
			...
			*/
			...
			if($lvl==7){
				echo "<td style='display:none'><button type='button' class='btn btn-primary btn-block btn-xs btndetkom' id='btndetkom'>DETAIL SKEMA</button></td>";
			} else {
				echo "<td ><button type='button' class='btn btn-primary btn-block btn-xs btndetkom' id='btndetkom'>DETAIL SKEMA</button></td>";
			}
