...
<script type="text/javascript">
	...
	function detail(nojo, jbtn, jid, ketrej, ketcan, upd, ntype, cuk){
		...
		*/
		...
		$.post(url, {data : vid}, function(res){
			...
			$('#listrincianr').dataTable({"bFilter": false, "bSort": true, "bAutoWidth": false, "bLengthChange": false, "bPaginate": true});
		})
	...
	function reload_table(){
		...
		$("#listorder").DataTable({
			...
			bSort : true,
			ajax: {
			  url 		: "<?php echo base_url().'index.php/mapping/data_listorder3';?>",
			  type 		:'POST',
			  dataType	: "json",
			  data		: dataString
			}, 
	...
	function detaily(nojo, jbtn, jid, ketrej, ketcan, upd, ntype, cuk, lvlxy){
		...
		$.post(url, {data : vid}, function(res){
			...
			$('#listrincianw').dataTable({"bFilter": false, "bSort": true, "bLengthChange": false, "bPaginate": true});
		})
          ...
          <!-- Main content -->
			...
			<?php } ?>
				...
				<div class="modal fade" id="LmyModal" role="dialog">
				  <div class="modal-dialog modal-lg" id="modal-alert" style="width:930px;">
					 <div class="modal-content">
						<div class="modal-header" style="background-color:blue; color:white;">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				...
				<div class="modal fade" id="VXmyModal" role="dialog">
				  <div class="modal-dialog modal-lg" id="modal-alert" style="width:980px;">
					 <div class="modal-content">
						<div class="modal-header" style="background-color:blue; color:white;">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							<h4 class="modal-title">Detail JO</h4>
