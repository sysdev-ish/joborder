	...
	$(function () {
		...
		*/
		...
		$('#addrincian').click(function(){
				...
				var komponenx	= $('#komponen :selected').text();
				...
				$('#listrincian > tbody:last-child').append('<tr><td class=lkompon style=display:none>'+ komponen +'</td><td class=lvalu>'+ komponenx +'</td><td class=lketer>'+ ket +'</td></tr>');
		...
		$('#btn_submit').click(function( e ){
			var larea 			= $('#larea').val(); 
			var vlpa 			= $('#lpa :selected').text();
			var lpa 			= $("#lpa").select2('data')[0]['id'];
			var lsl		 		= $('#lsl').val(); 
			...
			var url = "<?php echo base_url(); ?>index.php/skema/k_rincian_skema_simpan/";
			var	type 		= "POST";
			var mimeType    = "multipart/form-data";
			arrskem = [larea, lpa, lsl, ljabat, llv, lrincian];
		...
		$("#btndel").click(function () {
			...
			var url = "<?php echo base_url(); ?>" + "index.php/skema/k_del_all/";
			larr = [vsubkat];
		...
		$('#btn_edit').click(function( e ){
			...
			var url = "<?php echo base_url(); ?>index.php/skema/k_edit_rincian_skema/";
			var	type 		= "POST";
			var mimeType    = "multipart/form-data";
			arrskemx = [eid, eket];
		...
		function load_search(){
			...
			var url = "<?php echo base_url(); ?>index.php/skema/k_view_skema/";
			$.post(url, {larr:larr}, function(response){
				xTable.fnDestroy();
				$('#overlay').hide();
							...
							<div class="col-lg-3">
								<div class="form-group">
									...
									<div class="input-group" style="margin-left:+130px;">
										<select class="form-control select2" id="paing" name="paing">
							...
							<div class="col-lg-3">
								<div class="form-group">
									...
									<div class="input-group" >
										<select class="form-control select2" id="areaing" name="areaing" style="width:200px;">
							...
							<div class="col-lg-3">
								<div class="form-group">
									...
									<div class="input-group" style="margin-left:+118px;">
										<select class="form-control select2" id="sling" name="sling">
									...
									<th width="10%">
										<div class="form-group" id="divpar">
											...
											<div class="input-group" style="margin-bottom:15px">
												<select class="form-control select2 pull-right" id="lpa" name="lpa" style="width:400px;"/>
													<option value=""> Pilih PersonalArea</option>
													<?php echo $cmbpa; ?>
												</select>
											</div><!-- /.input group -->
								...
								<tr>
									<th>
										<div class="form-group" id="divare">
											...
											<div class="input-group" style="margin-bottom:15px">
												<select class="form-control select2" id="larea" style="width:400px;">
													<option value=""> Pilih Area</option>
													<option value="ALL"> Select All</option>
													<?php echo $cmbar; ?>
												</select>
								...
								<tr>
									<th>
										<div class="form-group" id="divslay">
											...
											<div class="input-group" style="margin-bottom:15px">
												<select class="form-control select2" id="lsl" style="width:400px;">
													<option value=""> Pilih SkillLayanan</option>
													<option value="ALL"> Select All</option>
													<?php echo $cmbsl; ?>
												</select>
								...
								<tr>
									<th>
										<div class="form-group" id="divjbt">
											...
											<div class="input-group" style="margin-bottom:15px">
												<select class="form-control select2" id="ljabat" style="width:400px;">
									...
									<th>
										<div class="form-group" id="divlvl">
											...
											<div class="input-group" style="margin-bottom:15px">
												...
												<select class="form-control select2" id="llv" style="width:400px;">
								...
								<div class="box-body">
									...
									<div class="form-group" id="divkomponen">
										...
										<div class="col-sm-9">
											...
											<input type="text" class="form-control pull-right" id="ekomponen" readonly/>
										</div><!-- /.input group -->
									</div><!-- /.form group -->
									...
									<div class="form-group" id="divval">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control pull-right" id="evalu" readonly/>
										</div><!-- /.input group -->
									</div><!-- /.form group -->
