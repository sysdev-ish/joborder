...
<script type="text/javascript">
	$(document).ready(function(){
		...
		xTable = $('#listkomponen').dataTable(optionx);
...
<section class="content">
	<div class="row">
		...
		<div class="col-md-12" id='lalay'>
			<div class="box box-primary" id='yeyey'>
				<div class="box-body">
					<table id="listkomponen" class="table table-bordered table-hover">
						<thead>
							<tr>
								<th style="background-color:#CC0000;"><font color="#FFFFFF"> PersonalArea</font></th>
						...
						<tbody>
							<?php
									if (count($lsuck)){
										foreach($lsuck as $key => $list){
											echo "<tr>";
											echo "<td class='tar'>". $list['wktxt'] ."</td>";
											echo "<td class='tpa'>". $list['bnama'] ."</td>";
											echo "<td class='tbid' style='display:none'>". $list['id'] ."</td>";
