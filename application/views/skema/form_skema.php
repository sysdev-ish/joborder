	...
	$(function () {$.fn.dataTable.ext.errMode = 'none';
		...
		*/
		...
		$('#btn_submit').click(function( e ){
			...
			if (abul == "" )
			{
				alert('Bulan periode perhitungan tidak boleh kosong');
				$('#divabul').attr('class','form-group has-error'); return false;} else if (ljabat != ""){$('#divabul').attr('class','form-group')
			}
		
			if (aper == "" )
			{
				alert('Periode Form Absensi tidak boleh kosong');
				$('#divaper').attr('class','form-group has-error'); return false;} else if (ljabat != ""){$('#divaper').attr('class','form-group')
			}
			...
			*/
			...
			arrskem = [larea, vlpa, lsl, ljabat, llv, lidsk, ltpk, lrincian, ltpaa, ltpab, ltpfa, tlwk, abul, aper];
				...
				<div class="box box-default">
					<div class="box-header with-border">
						...
						-->
							<div class="col-lg-3">
								<div class="form-group">
									<label class="col-sm-3 control-label" >Persa</label>
									<div class="input-group" style="border: 0.1px solid grey;">
										<select class="form-control select2 pull-right" id="paing" name="paing">
							...
							<div class="col-lg-3">
								<div class="form-group">
									...
									<div class="input-group" style="border: 0.1px solid grey;">
										<select class="form-control select2 pull-right" id="areaing" name="areaing">
					...
					<div id="nana">
						<form role="form">
							...
							<table width="100%" border="0"> 
								<tr>
									<th width="10%">
										<div class="form-group" id="divare">
											...
											<div class="input-group" style="margin-bottom:15px; border: 0.1px solid grey;">
								...
								<tr>
									<th>
										<div class="form-group" id="divpar">
											...
											<div class="input-group" style="margin-bottom:15px; border: 0.1px solid grey;">
												<select class="form-control select2 pull-right" id="larea" name="larea" style="width:400px;">
													<option value=""> Pilih Area</option>
													<option value='ALL'>SELECT ALL</option>
													<?php foreach($cmbarea as $key => $list){ ?>			
													<option value="<?php echo $list->AREA; ?>"><?php echo $list->AREA_TEXT; ?></option>
								...
								<tr>
									<th>
										<div class="form-group" id="divabul">
											<label class="control-label">Bulan</label>
											<div class="input-group">
												<div class="input-group-addon">
													<i class="fa fa-calendar"></i>
												</div>
												<input type="text" class="form-control" id="abulan" value='N'/>
											</div>
										</div>
									</th>
								</tr>
								...
								<tr>
									<th>
										<div class="form-group" id="divaper">
											<label class="control-label">Periode</label>
											<div class="input-group">
												<div class="input-group-addon">
													<i class="fa fa-calendar"></i>
												</div>
												<input type="text" class="form-control" id="aperiode" value='N+1'/>
											</div>
										</div>
									</th>
								</tr>
									...
									<th>
										<div class="form-group" id="divlwk">
											...
											<div class="input-group">
												...
												<select class="form-control" id="lwk" name="lwk" style="width:400px;">
