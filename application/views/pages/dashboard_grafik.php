...
$(function () {	
	...
	kTable = $('#repnew').dataTable(option);
})
</script>
-->
			...
			data: [
					...
					if(count($graph)>0)
					{
					   foreach ($graph as $data) {
					   		...
					   		if(($data->id)==1)
						    {
						  		 echo "['". $data->name_province . "'," . $data->jumlah ."],\n";
							}
							else if(($data->id)==2)
						    {
						  		 echo "['". $data->name_province . "'," . $data->jumlah ."],\n";
							...
							*/
							...
							/*
							if(($data->lokasi)==($data->city_name))
							{
								echo "['". $data->lokasi . "'," . $data->total ."],\n";
							}
							else if(($data->lokasi)==($data->bid))
							{
								echo "['". $data->name_province . "'," . $data->jml ."],\n";
							}
							*/
							
							/*
							if(!filter_var($data->lokasi, FILTER_VALIDATE_INT)) 
							{    
								echo "['". $data->lokasi . "'," . $data->total ."],\n";
							} 
							else 
							{    
								echo "['". $data->city_name . "'," . $data->total ."],\n";
							}   
							 */
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><a href="<?php echo base_url(); ?>index.php/home/dashboard_newjo/" ><?php 
														// echo $telkomgroup.'-----------------------';
													// if (count($telkomgroup)){
														echo $telkomgroup;
														// foreach($telkomgroup as $list){
															// echo $list['jml'];
														// }
													// }
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><a href="<?php echo base_url(); ?>index.php/home/dashboard_ontime/" > <?php 
										echo $infomedia;
										// if (count($infomedia)){
											// foreach($infomedia as $list){
												// echo $list['jml'];
											// }
										// } 
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><a href="<?php echo base_url(); ?>index.php/home/dashboard_over/" > <?php 
											echo $group;
										// if (count($group)){
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><a href="<?php echo base_url(); ?>index.php/home/dashboard_cancel/" ><?php 
										echo $telkom;
										// if (count($telkom)){
											// foreach($telkom as $list){
												// echo $list['jml'];
											// }
										// } 
              ...
              <div class="row">
				  ...
				  <tbody>
					...
					if (count($wew)){
						foreach($wew as $key => $list){
							echo "<tr>";
							if($list['npersa']!='' OR $list['npersa']!=null){
								echo "<td>". $list['npersa'] ."</td>";
							} else {
				...
				<div class="col-md-12">
                  <div class="chart">
						 <div class="box box-success">
							<div class="box-body">
								<table id="repnew" width="100%" class="table table-bordered table-hover">
									<thead bgcolor="#FF6666"; >
										<tr>
										  <td>NOJO</td>
										  <td>Client</td>
										...
										<tr>
										  <td><input type="text" id="cari_nojo" style="width:100%"></td>
										  <td><input type="text" id="cari_client" style="width:100%"></td>
										  <td><input type="text" id="cari_project" style="width:100%"></td>
										  <td></td>
										  <td></td>
										  <td></td>
										  <td></td>
...
function load_data(is_carno,  is_carcli, is_carpro)
{
	var xTable =
	$("#repnew").DataTable({
		processing: true,
		...
		bSort : true,
		ajax: {
			url 		: "<?php echo base_url().'index.php/mapping/data_dashboard';?>",
			type 		:'POST',
			dataType	: "json",
			// data		: dataString
			data:{is_carno:is_carno, is_carcli:is_carcli, is_carpro:is_carpro}
			// "data"          : function (data) {
				// data.cano     = $("#cari_nojo").val();
				// data.cacli    = $("#cari_client").val();
				// data.capro    = $("#cari_project").val();
			// }
		},
...
/*
$("#cari_nojo").change(function(){
	var cari_nojo = $("#cari_nojo").val();
	$('#repnew').DataTable().destroy();
	if(cari_nojo != '')
	{
		load_data(cari_nojo);
	}
...
$(document).on('keyup change', '#cari_nojo', function(){
	var carno  = $(this).val();
	var carcli = $("#cari_client").val();
	var carpro = $("#cari_project").val();
	$('#repnew').DataTable().destroy();
	if(carno != '')
	{
	load_data(carno, carcli, carpro);
	}
	else
	{
	load_data();
...
$(document).on('keyup change', '#cari_client', function(){
	var carcli = $(this).val();
	var carno  = $("#cari_nojo").val();
	var carpro = $("#cari_project").val();
	$('#repnew').DataTable().destroy();
	if(carcli != '')
	{
...
$(document).on('keyup change', '#cari_project', function(){
	var carpro = $(this).val();
	var carno  = $("#cari_nojo").val();
	var carcli = $("#cari_client").val();
	$('#repnew').DataTable().destroy();
